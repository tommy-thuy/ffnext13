...
import { ProjectDetails } from '@/components/ZustandPortfolio/ProjectDetails'
...
export async function generateMetadata({ params }: { params: { id: string } }) {
  ...
  const APP_NAME = `Coder | ${projectsData.project_name}`
  ...
  return {
    ...
    authors: [
      { name: 'tommy-thuy' },
      { name: 'tommy-thuy', url: 'https://www.linkedin.com/in/tommy-thuy-0b9462128' },
    ],
    viewport:
