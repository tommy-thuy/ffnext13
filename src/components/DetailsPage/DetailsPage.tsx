...
import LoadingDetailsPagePlaceholder from '../loading-placeholders/LoadingDetailsPagePlaceholder';
      ...
      {!loading ? (
        <div className="flex flex-col mt-8 mb-6 overflow-hidden">
          ...
          {details?.actors && details?.actors.length > 0 ? (
            <div className="p-6">
              <h2 className="font-semibold text-lg mt-0 mb-4">Cast</h2>
              <div className="overflow-hidden relative w-full">
                <div className="flex flex-no-wrap max-w-full overflow-x-scroll overflow-y-hidden pb-12 -mb-0">
