...
function FilterSidebar({ genres }: { genres: Array<Genre> }) {
  ...
  return (
    <div className='sticky top-4 h-[60vh] border-2 px-4 py-4 rounded-md'>
      
      <h2 className='text-2xl capitalize'>Fitlers</h2>
      ...
      <form className='mt-4'>
        ...
        <button
          ...
          type='submit'
          className='w-full p-2 mt-4 bg-accent rounded-md border-[1.5px] border-[#ff9aba]  text-accent-foreground shadow-[inset_0px_1px_#ffffff66] bg-gradient-to-b from-[#5a67d8] to-[#7f9cf5] text-shadow hover:from-[#ff6898] hover:to-[#7f9cf5]'
        >
          Search
        </button>
      </form>
